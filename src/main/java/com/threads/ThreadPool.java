...
/*   * When using the threads in a program, it is costly to recreate each time
     * However, by making a thread pool and taking it from the pool depending on need.
     * After using thread you can put thread into pool again.
     * in the newFixedThreadPool method you  can change the parameter how many thread you need int the pool
     * */
